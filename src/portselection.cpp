...
void PortSelection::initPort(void)
{
    ...
    if (fstream){
        ...
        fstream << m_name->text().toStdString() << ";"
                << box_baud->currentText().toStdString() << ";"
                << box_dataBits->currentText().toStdString() << ";"
                << box_flowControl->currentText().toStdString() << ";"
                << box_parity->currentText().toStdString() << ";"
                << box_stopBit->currentText().toStdString() << std::endl;
